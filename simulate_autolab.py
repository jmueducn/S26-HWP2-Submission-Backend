...
# Create a dummy student submission ZIP file (for testing) 
make dummy_submission

# Run the simulation on a submission
python simulate_autolab.py submission.zip

# Or keep the simulation directory for debugging
python simulate_autolab.py submission.zip --keep
...
if __name__ == "__main__":
    ...
    parser.add_argument("submission", help="Path to student's submission file (handin.zip)")
